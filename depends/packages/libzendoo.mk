...
define $(package)_build_cmds
  $($(package)_cargo_ld) $($(package)_cargo_cc) CARGO_TARGET_X86_64_UNKNOWN_LINUX_GNU_LINKER=$(CT_PREFIX)gcc RUSTFLAGS="$($(package)_target_feature)" cargo build $($(package)_build_opts)
endef
